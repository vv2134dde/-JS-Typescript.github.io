...
class PostedComment {
    ...
    reply(date: string): void {
        isItReply = date;
        textarea.focus();
    }

    favorites(toFavorites: HTMLButtonElement): void {
    ...
    like(likesDiv: HTMLElement): void {
        const info = commentsInfo.find(el => el.date === this.date);
    ...
    dislike(likesDiv: HTMLElement): void {
        const info = commentsInfo.find(el => el.date === this.date);
    ...
    getHTMLElement(name: string): void {
...
const numOfComDiv: HTMLElement = document.getElementById('numberOfComments');
const dropdownBtn: HTMLButtonElement = document.querySelector('.dropdown-toggle');
...
const favoritesBtn: HTMLButtonElement = (document.getElementById('favorites') as HTMLButtonElement);
const textarea: HTMLTextAreaElement = (document.getElementById('comment') as HTMLTextAreaElement);
const sizeControl: HTMLElement = document.querySelector('.comment');
const charsCounter: HTMLElement = document.querySelector('.charsCounter');
const postBtn: HTMLButtonElement = (document.getElementById('comment-button') as HTMLButtonElement);
const warning: HTMLElement = document.querySelector('.warning');
const commentsDiv: HTMLElement = document.querySelector('.comments');

const icon: HTMLElement = document.getElementById('icon');
...
let commentsInfo: CommentInfo[] = [];
let comments: PostedComment[] = [];

let isItReply: boolean | string = false;

let id: number;

dropdownBtn.onclick = (): void => {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    dropdownItems.forEach(item => {
        item.onclick = (): void => {
            ...
            const sortValue: string = (item as HTMLElement).dataset.value;
            ...
            dropdownBtn.innerText = (item as HTMLElement).innerText;
